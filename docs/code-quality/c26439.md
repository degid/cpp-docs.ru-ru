...
- Нестандартные и устаревшие описатели, такие как throw() или declspec(throw), не эквивалентны "noexcept".
- Явные спецификаторы noexcept(false) и noexcept(true) учитываются соответствующим образом.
