...
|[operator< (map) (STL/CLR)](#op_lt)|Определяет `map` , меньше ли объект, чем другой `map` объект.|
...
|[operator> (map) (STL/CLR)](#op_gt)|Определяет `map` , больше ли объект, чем другой `map` объект.|
|[operator>= (map) (STL/CLR)](#op_gteq)|Определяет `map` , больше или равен ли объект другому `map` объекту.|
