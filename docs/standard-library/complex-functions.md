...
*Модуль* комплексного числа — это мера длины вектора, представляющего комплексное число. Модуль комплексного числа a + bi — это sqrt (a<sup>2</sup> + b<sup>2</sup>), пишется как &#124;a + bi&#124;. *norm* комплексного числа a + bi — это (a<sup>2</sup> + b<sup>2</sup>), так что модуль комплексного числа — это квадратный корень из его нормы.
